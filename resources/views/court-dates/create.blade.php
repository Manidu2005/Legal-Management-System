            ...
            <div class="p-6">
                <form method="POST" action="{{ route('court-dates.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <select id="case_id" name="case_id" class="input-dynamic mt-1">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-mist-500 dark:text-mist-400 mb-3">{{ __('Select the type of court appearance') }}</p>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <label class="relative cursor-pointer">
                                ...
                                <div class="flex flex-col items-center p-6 rounded-lg border-2 border-mist-950/10 dark:border-white/10
                                            peer-checked:border-sky-500 peer-checked:bg-sky-50 dark:peer-checked:bg-sky-500/10
                                            hover:border-sky-300 dark:hover:border-sky-500/40 transition-all duration-200">
                                    <div class="w-12 h-12 rounded-full bg-sky-100 dark:bg-sky-500/10 flex items-center justify-center mb-3">
                                    ...
                                    <span class="text-sm font-semibold text-mist-950 dark:text-white">{{ __('Calling Date') }}</span>
                                    <span class="text-xs text-mist-500 dark:text-mist-400 mt-1 text-center">{{ __('Regular court appearance for case management') }}</span>
                                </div>
                                {{-- Checkmark indicator --}}
                            ...
                            <label class="relative cursor-pointer">
                                ...
                                <div class="flex flex-col items-center p-6 rounded-lg border-2 border-mist-950/10 dark:border-white/10
                                            ...
                                            hover:border-red-300 dark:hover:border-red-500/40 transition-all duration-200">
                                    <div class="w-12 h-12 rounded-full bg-red-100 dark:bg-red-500/10 flex items-center justify-center mb-3">
                                    ...
                                    <span class="text-sm font-semibold text-mist-950 dark:text-white">{{ __('Trial Date') }}</span>
                                    <span class="text-xs text-mist-500 dark:text-mist-400 mt-1 text-center">{{ __('Formal trial hearing — triggers billing & reminders') }}</span>
                                </div>
                                {{-- Checkmark indicator --}}
                                <div class="absolute top-3 right-3 hidden peer-checked:block">
                    ...
                    {{-- Submit --}}
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-mist-950/10 dark:border-white/10">
