            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-4">
                    <form method="GET" action="{{ route('users.index') }}" class="flex items-center gap-4">
                        <x-input-label for="role" value="Filter by Role" class="whitespace-nowrap" />
                        ...
                        @if(request('role'))
                            <a href="{{ route('users.index') }}" class="text-sm text-gray-500 hover:text-gray-700 underline">Clear</a>
                        @endif
                    </form>
                </div>
            </div>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($user->role === 'partner')
                                                <span class="inline-flex items-center rounded-full bg-purple-100 px-2.5 py-0.5 text-xs font-medium text-purple-800">Partner</span>
                                            @elseif($user->role === 'associate')
                                                <span class="inline-flex items-center rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800">Associate</span>
                                            @else
                                                <span class="inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800">Clerk</span>
                                            @endif
                                        </td>
