                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                            ...
                            <dl class="space-y-2">
                                ...
                                <div>
                                    <dt class="text-xs text-gray-500">NIC</dt>
                        ...
                        <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                            ...
                            <dl class="space-y-2">
                                <div>
                                    <dt class="text-xs text-gray-500">Case ID</dt>
                                    <dd class="text-sm font-medium text-gray-900">#{{ $case->id }}</dd>
                                </div>
                                <div>
                                    <dt class="text-xs text-gray-500">Case Type</dt>
                        ...
                        <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                            ...
                            <dl class="space-y-2">
                                ...
                                <div>
                                    ...
                                    <dd class="text-sm font-medium text-gray-900">{{ ucfirst($case->assignedAttorney->role ?? '—') }}</dd>
                                </div>
                                <div>
                ...
                <div x-show="activeTab === 'court_dates'" class="p-6">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Reminder</th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr class="transition hover:bg-gray-50">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4 text-sm">
                                                ...
                                                <span class="inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold {{ $typeBadge }}">
                                                    {{ str_replace('_', ' ', ucfirst($courtDate->type)) }}
                                                </span>
                                            </td>
                                            <td class="whitespace-nowrap px-6 py-4 text-sm">
                    ...
                    @else
                        <div class="py-12 text-center">
                            ...
                            <p class="text-sm font-medium text-gray-500">No court dates recorded</p>
                            <p class="mt-1 text-sm text-gray-400">Court dates will appear here once added.</p>
                        </div>
                    @endif
                </div>
                ...
                <div x-show="activeTab === 'documents'" x-cloak class="p-6">
                                        ...
                                        <tr class="transition hover:bg-gray-50">
                                            <td class="whitespace-nowrap px-6 py-4 text-sm">
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="font-medium text-gray-900">{{ basename($document->file_path) }}</span>
                                                </div>
                                            </td>
                                            <td class="whitespace-nowrap px-6 py-4 text-sm">
                    ...
                    @else
                        <div class="py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-400">Documents will appear here once uploaded.</p>
                        </div>
                    @endif
                </div>
                    ...
                    <div x-show="activeTab === 'billing'" x-cloak class="p-6">
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div class="rounded-lg border border-gray-200 bg-gradient-to-br from-indigo-50 to-white p-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-gray-500">Total Appearance Fee</p>
                                ...
                                <p class="mt-2 text-xs text-gray-400">
                                    {{ $case->courtDates->count() }} court date(s) × LKR {{ number_format($case->assignedAttorney->flat_appearance_rate ?? 0, 2) }} per appearance
                                </p>
                            </div>
                            ...
                            <div class="rounded-lg border border-gray-200 bg-gradient-to-br from-emerald-50 to-white p-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-gray-500">Ledger Total</p>
                                ...
                                <p class="mt-2 text-xs text-gray-400">
                                    {{ $case->ledgerEntries->count() }} ledger entr{{ $case->ledgerEntries->count() === 1 ? 'y' : 'ies' }}
                                </p>
                            </div>
                        </div>
