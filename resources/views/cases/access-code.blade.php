<x-app-layout>
    ...
    <div class="max-w-md mx-auto">
        <div class="glass-card p-6 sm:p-8">
            <svg class="mx-auto h-10 w-10 text-mist-400 dark:text-mist-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>

            <h3 class="mt-4 text-center text-lg font-semibold text-mist-950 dark:text-white">
                {{ __('This case is protected') }}
            </h3>
            <p class="mt-2 text-center text-sm text-mist-500 dark:text-mist-400">
            ...
            <div class="mt-4 text-center">
                <a href="{{ route('cases.index') }}" class="link-subtle underline">
