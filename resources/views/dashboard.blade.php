<x-app-layout>
    <x-slot name="header">
        ...
        <div class="hidden sm:block text-right">
            ...
            <p class="text-xs text-slate-400 font-medium tracking-wider uppercase mt-0.5">Today's Overview</p>
        </div>
    </x-slot>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="glass-card p-6 hover-lift border border-white/50 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-4 mb-4 relative z-10">
                ...
                <div>
                    <p class="text-sm font-semibold text-slate-500 uppercase tracking-wider">Total Cases</p>
            ...
            <div class="relative z-10 text-sm text-indigo-600 font-medium flex items-center gap-1">
                Active matters on record <span class="group-hover:translate-x-1 transition-transform">→</span>
            </div>
        </div>
        ...
        <div class="glass-card p-6 hover-lift border border-white/50 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-4 mb-4 relative z-10">
                ...
                <div>
                    <p class="text-sm font-semibold text-slate-500 uppercase tracking-wider">Court Dates</p>
            ...
            <div class="relative z-10 text-sm text-sky-600 font-medium flex items-center gap-1">
                Upcoming proceedings <span class="group-hover:translate-x-1 transition-transform">→</span>
            </div>
        </div>
        ...
        <div class="glass-card p-6 hover-lift border border-white/50 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-4 mb-4 relative z-10">
                ...
                <div>
                    <p class="text-sm font-semibold text-slate-500 uppercase tracking-wider">Active Clients</p>
            ...
            <div class="relative z-10 text-sm text-emerald-600 font-medium flex items-center gap-1">
                Registered profiles <span class="group-hover:translate-x-1 transition-transform">→</span>
            </div>
        </div>
        ...
        <div class="glass-card p-6 hover-lift border border-white/50 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-4 mb-4 relative z-10">
                ...
                <div>
                    <p class="text-sm font-semibold text-slate-500 uppercase tracking-wider">Documents</p>
            ...
            <div class="relative z-10 text-sm text-amber-600 font-medium flex items-center gap-1">
                Files in secure vault <span class="group-hover:translate-x-1 transition-transform">→</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="glass-card p-6 border border-white/50">
                <h3 class="heading-section !text-xl mb-6">Quick Actions</h3>
                <div class="space-y-3">
                    <a href="{{ route('cases.create') }}" class="group flex items-center justify-between p-4 rounded-xl bg-slate-50 hover:bg-indigo-50 border border-slate-100 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-medium text-slate-700 group-hover:text-indigo-700">Open new case</span>
                        </div>
                    ...
                    <a href="{{ route('clients.create') }}" class="group flex items-center justify-between p-4 rounded-xl bg-slate-50 hover:bg-sky-50 border border-slate-100 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-medium text-slate-700 group-hover:text-sky-700">Register client</span>
                        </div>
                    ...
                    <a href="{{ route('documents.create') }}" class="group flex items-center justify-between p-4 rounded-xl bg-slate-50 hover:bg-emerald-50 border border-slate-100 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-medium text-slate-700 group-hover:text-emerald-700">Upload document</span>
                        </div>
        ...
        <div class="lg:col-span-2">
            <div class="glass-card p-6 border border-white/50 h-full">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="heading-section !text-xl">Workspace Modules</h3>
                    <div class="px-3 py-1 bg-slate-100 text-slate-600 rounded-full text-xs font-semibold uppercase tracking-wider">Explore</div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <a href="{{ $url }}" class="group block p-5 rounded-2xl border border-slate-200/60 bg-white/40 hover:bg-white hover:border-{{ $color }}-200 hover:shadow-lg hover:shadow-{{ $color }}-500/10 transition-all duration-300">
                        <div class="flex items-center justify-between mb-2">
                            <h4 class="font-heading font-bold text-lg text-slate-800 group-hover:text-{{ $color }}-600 transition-colors">{{ $label }}</h4>
